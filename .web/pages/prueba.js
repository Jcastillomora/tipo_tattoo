...
export function Textfield__root_b6c993f6da41779e5891f6db514d6ae6 () {
  
  const [addEvents, connectErrors] = useContext(EventLoopContext);


  const on_blur_0fcebef2eeffa5ac43cad129ea11fbe7 = useCallback(((_e) => (addEvents([(Event("reflex___state____state.tipo_tattoer___backend___backend____state.set_phone_number", ({ ["value"] : _e["target"]["value"] }), ({  })))], [_e], ({  })))), [addEvents, Event])



  
  return (
    <RadixThemesTextField.Root css={({ ["borderColor"] : "blue.300" })} onBlur={on_blur_0fcebef2eeffa5ac43cad129ea11fbe7} placeholder={"+34123456789"} size={"2"}/>
  )
}

export function Text_3646f8adf1acc506cadf44418d03b899 () {
  ...
  return (
    <RadixThemesText as={"p"} css={({ ["textDecoration"] : "none", ["color"] : "green.600" })}>

{reflex___state____state__tipo_tattoer___backend___backend____state.status_message}
</RadixThemesText>
  )
}
...
export function Errorboundary_2f06f804c6139e04482ad3d140bfa9b3 () {
...
{"Ejemplo Twilio + Reflex"}
</RadixThemesHeading>
<RadixThemesText as={"p"} css={({ ["textDecoration"] : "none" })}>

{"Ingresa tu n\u00famero con formato internacional (e.g., +34612345678):"}
</RadixThemesText>
<Textfield__root_b6c993f6da41779e5891f6db514d6ae6/>
<Button_2da00725eb27235204c6d2e4fc6a8f30/>
<Text_3646f8adf1acc506cadf44418d03b899/>
</RadixThemesFlex>
<NextHead>
...
export function Button_2da00725eb27235204c6d2e4fc6a8f30 () {
  
  const [addEvents, connectErrors] = useContext(EventLoopContext);


  const on_click_43fde20de654083b47a2a39cd056689f = useCallback(((...args) => (addEvents([(Event("reflex___state____state.tipo_tattoer___backend___backend____state.send_whatsapp_message", ({  }), ({  })))], args, ({  })))), [addEvents, Event])



  
  return (
    <RadixThemesButton color={"blue"} onClick={on_click_43fde20de654083b47a2a39cd056689f}>
...
export default function Component() {
  ...
  return (
    <Errorboundary_2f06f804c6139e04482ad3d140bfa9b3/>
  )
}
